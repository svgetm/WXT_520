...
@Table(name = "METEOROLOGICALDATA_METEO_DATA")
@Entity(name = "meteorologicaldata_MeteoData")
@PublishEntityChangedEvents

public class MeteoData extends StandardEntity {
    private static final long serialVersionUID = -8942794420171475550L;
